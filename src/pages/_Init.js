    ...
    if (
      ...
      setTimeout(() => {
        ...
        this.props.deployIdentityContract(
          'IdentityIssuer',
          'certifier',
          // 'https://identity.verismart.ai/fb-auth',
          'https://erc725.originprotocol.com/fb-auth',
          false,
          'facebook',
          [
            {
              // uri: 'https://identity.verismart.ai/fb-auth',
              uri: 'https://erc725.originprotocol.com/fb-auth',
              icon: 'facebook',
              claimType: '3'
            },
            {
              // uri: 'https://identity.verismart.ai/twitter-auth',
              uri: 'https://erc725.originprotocol.com/twitter-auth',
              icon: 'twitter',
              claimType: '4'
            },
            {
              // uri: 'https://identity.verismart.ai/github-auth',
              uri: 'https://erc725.originprotocol.com/github-auth',
              icon: 'github',
              claimType: '5'
            },
            {
              // uri: 'https://identity.verismart.ai/google-auth',
              uri: 'https://erc725.originprotocol.com/google-auth',
              icon: 'google',
              claimType: '6'
            },
            {
              // uri: 'https://identity.verismart.ai/linkedin-auth',

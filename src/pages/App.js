      ...
      <div>
        ...
        <nav className="navbar navbar-expand-sm navbar-light">
          <div className="container">
            ...
            >
              <a href="https://identity.verismart.ai">Digital Identity ERC-725</a>
            </Link>
        ...
        <div className="container">
          ...
          <div className="footer">
            <div className="powered-by">
              <a href="https://verismart.ai">
                <img src="images/logo.png" />
              </a>
            </div>
            <div className="middle">
              &copy;{' 2018 '}
              <a className="ml-1" href="https://verismart.ai">
                verismart-BnB Bot & Blockchain
              </a>
            </div>
            <div className="right">
